...
<div class="container" id="sous_famille">
    <div class="grid grid-cols-1 gap-4 text-center my-40 mx-auto">
        @foreach ($sous_familles as $sousfamille)
        <a href={{"/sous_famille/$sousfamille->id"}}>
        <div class="flex bg-white border relative border-gray-300 dark:bg-dark-eval-2 dark:border-dark-eval-3 rounded-xl overflow-hidden items-center justify-start cursor-pointer"
                style="cursor: auto;">
                ...
                <div class="relative w-32 h-32 flex-shrink-0">
                    ...
                    <div class="absolute left-0 top-0 w-full h-full flex items-center justify-center">
                        ...
                        <img class="absolute left-0 top-0 w-full h-full object-cover object-center transition duration-50"
                            loading="lazy" src="{{ url("/uploads/sous_familles_imgs/$sousfamille->photo") }}" />
