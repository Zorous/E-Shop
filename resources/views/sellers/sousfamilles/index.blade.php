...
<div class="m-5">
    ...
    @endif
    <a class="text-sm bg-orange-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" href="{{ route('sous-familles.create') }}"><i class="fa-solid fa-square-plus"></i> Ajouter une sous famille</a>
</div>
    <div class="overflow-auto p-9 rounded-lg shadow-md hidden md:block bg-white dark:bg-dark-eval-2 dark:text-white border-spacing-2">
            ...
            <tbody>
                ...
                @foreach ($sousfamilles as $sousfamille)
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        <td class="relative w-100 h-32 flex-shrink-0">
                            <div class="absolute left-0 top-0 w-full h-full flex items-center justify-center">
                            <img class="absolute left-0 top-0 w-full h-full object-cover object-center transition duration-50" src="{{ url("/uploads/sous_familles_imgs/$sousfamille->photo") }}" />
                        </div>
                    </td>
                        <td class="px-6 py-4 text-center text-xl bg-gray-50 dark:bg-gray-800">{{ $sousfamille->sous_famille }}</td>
                        <td class="px-6 py-4 text-sm text-gray-700 dark:text-white border-spacing-2">
                            @if ($sousfamille->active === 1)
                                <span
                        ...
                        <td class="px-6 py-4 text-center bg-gray-50 dark:bg-gray-800">
                           <div class="flex">
                            <a href={{route('sous-familles.edit',$sousfamille->id)}} class="text-lg mr-5">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                            <form action="{{ route('sous-familles.destroy',$sousfamille->id) }}" method="post">
                                @csrf
                                @method('DELETE')
        ...
        <div class="flex bg-white border relative border-gray-300 dark:bg-dark-eval-2 dark:border-dark-eval-3 rounded-xl overflow-hidden items-center justify-start" style="cursor: auto;">
            ...
            <div class="relative w-32 h-32 flex-shrink-0">
              ...
              <div class="absolute left-0 top-0 w-full h-full flex items-center justify-center">
                ...
                <img class="absolute left-0 top-0 w-full h-full object-cover object-center transition duration-50" loading="lazy" src="{{ url("/uploads/sous_familles_imgs/$sousfamille->photo") }}" />
            ...
            <div class="p-4 flex">
              ...
              <h1 class="line-clamp-1 text-3xl"><b>{{ $sousfamille->sous_famille }}</b></h1>
