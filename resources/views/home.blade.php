                  ...
                  <div class="containt_main">
                     ...
                     <div class="header_box">
                        <div class="lang_box ">
                           ...
                           <img src={{ url("/assets/images/flag-uk.png")}}alt="flag" class="mr-2 " title="United Kingdom"> English <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                           </a>
                           <div class="dropdown-menu ">
                              <a href="#" class="dropdown-item">
                              <img src={{ url("/assets/images/flag-france.png")}}class="mr-2" alt="flag">
                              French
                              </a>
                           </div>
                        </div>
